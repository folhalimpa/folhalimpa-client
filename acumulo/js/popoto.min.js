popoto = function() {
    ...
    a.graph.TOOL_FULL_SCREEN = "Full screen";
    ...
    a.graph.createGraphArea = function() {
        ...
        if (a.tools.RESET_GRAPH) c.append("span").attr("id", "popoto-reset-menu").attr("class", "ppt-icon ppt-menu reset").attr("title", a.graph.TOOL_RESET).on("click", a.tools.reset);
